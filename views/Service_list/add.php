<section id="main-content">
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
        <section class="card">  
            <header class="card-header"><h4><b>Create Service</b></h4></header>
            <div class="card-body">   
	           <form  method="post" action="<?php echo base_url('Service_list/insertdata');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <select class="form-control" name="service_type_id" id="service_type_id">
										...
										<?php if(!empty($service)){ foreach($service as $ser) { ?>
										<option value="<?php echo $ser->TypeID; ?>">
                               ...
                               <div class="form-group">
                                 ...
                                 <textarea  name="description_e" id="description_e"  class="form-control" placeholder="Enter Your Description" required></textarea>
                            </div>                                               
                        </div>
                         </div>
